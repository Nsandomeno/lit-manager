...
class AssetStatsAsset(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["asset_id", b"asset_id", "asset_name", b"asset_name", "asset_type", b"asset_type", "genesis_height", b"genesis_height", "genesis_point", b"genesis_point", "genesis_timestamp", b"genesis_timestamp", "total_supply", b"total_supply"]) -> None: ...
