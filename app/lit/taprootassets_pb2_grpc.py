...
class TaprootAssets(object):
    ...
    def SubscribeSendAssetEventNtfns(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/taprpc.TaprootAssets/SubscribeSendAssetEventNtfns',
    ...
    def SubscribeReceiveAssetEventNtfns(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/taprpc.TaprootAssets/SubscribeReceiveAssetEventNtfns',
