...
class MintAsset(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["amount", b"amount", "asset_meta", b"asset_meta", "asset_type", b"asset_type", "asset_version", b"asset_version", "group_anchor", b"group_anchor", "group_key", b"group_key", "name", b"name"]) -> None: ...
...
class MintAssetRequest(google.protobuf.message.Message):
    ...
    ENABLE_EMISSION_FIELD_NUMBER: builtins.int
    ...
    def ClearField(self, field_name: typing_extensions.Literal["asset", b"asset", "enable_emission", b"enable_emission", "short_response", b"short_response"]) -> None: ...
...
class MintingBatch(google.protobuf.message.Message):
    ...
    @property
    def assets(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MintAsset]:
    ...
    def __init__(
        ...
        *,
        ...
        batch_txid: builtins.str = ...,
        state: global___BatchState.ValueType = ...,
        assets: collections.abc.Iterable[global___MintAsset] | None = ...,
    ) -> None: ...
