...
import api.assetwallet_pb2 as assetwallet__pb2
...
def add_AssetWalletServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'FundVirtualPsbt': api.unary_unary_rpc_method_handler(
            ...
            'SignVirtualPsbt': api.unary_unary_rpc_method_handler(
            ...
            'AnchorVirtualPsbts': api.unary_unary_rpc_method_handler(
            ...
            'NextInternalKey': api.unary_unary_rpc_method_handler(
            ...
            'NextScriptKey': api.unary_unary_rpc_method_handler(
            ...
            'ProveAssetOwnership': api.unary_unary_rpc_method_handler(
            ...
            'VerifyAssetOwnership': api.unary_unary_rpc_method_handler(
            ...
            'RemoveUTXOLease': api.unary_unary_rpc_method_handler(
...
class AssetWallet(object):
    ...
    def FundVirtualPsbt(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/assetwalletrpc.AssetWallet/FundVirtualPsbt',
    ...
    def SignVirtualPsbt(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/assetwalletrpc.AssetWallet/SignVirtualPsbt',
    ...
    def AnchorVirtualPsbts(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/assetwalletrpc.AssetWallet/AnchorVirtualPsbts',
    ...
    def NextInternalKey(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/assetwalletrpc.AssetWallet/NextInternalKey',
    ...
    def NextScriptKey(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/assetwalletrpc.AssetWallet/NextScriptKey',
    ...
    def ProveAssetOwnership(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/assetwalletrpc.AssetWallet/ProveAssetOwnership',
    ...
    def VerifyAssetOwnership(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/assetwalletrpc.AssetWallet/VerifyAssetOwnership',
    ...
    def RemoveUTXOLease(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/assetwalletrpc.AssetWallet/RemoveUTXOLease',
