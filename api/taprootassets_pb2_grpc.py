...
class TaprootAssetsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SubscribeSendAssetEventNtfns = channel.unary_stream(
                ...
                request_serializer=taprootassets__pb2.SubscribeSendAssetEventNtfnsRequest.SerializeToString,
                response_deserializer=taprootassets__pb2.SendAssetEvent.FromString,
                )
        self.SubscribeReceiveAssetEventNtfns = channel.unary_stream(
                '/taprpc.TaprootAssets/SubscribeReceiveAssetEventNtfns',
                request_serializer=taprootassets__pb2.SubscribeReceiveAssetEventNtfnsRequest.SerializeToString,
                response_deserializer=taprootassets__pb2.ReceiveAssetEvent.FromString,
                )
...
def add_TaprootAssetsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ListAssets': api.unary_unary_rpc_method_handler(
                    servicer.ListAssets,
            ...
            'ListUtxos': api.unary_unary_rpc_method_handler(
                    servicer.ListUtxos,
            ...
            'ListGroups': api.unary_unary_rpc_method_handler(
                    servicer.ListGroups,
            ...
            'ListBalances': api.unary_unary_rpc_method_handler(
            ...
            'ListTransfers': api.unary_unary_rpc_method_handler(
            ...
            'QueryAddrs': api.unary_unary_rpc_method_handler(
                    servicer.QueryAddrs,
            ...
            'NewAddr': api.unary_unary_rpc_method_handler(
                    servicer.NewAddr,
            ...
            'DecodeAddr': api.unary_unary_rpc_method_handler(
                    servicer.DecodeAddr,
                    request_deserializer=taprootassets__pb2.DecodeAddrRequest.FromString,
                    response_serializer=taprootassets__pb2.Addr.SerializeToString,
            ),
            'AddrReceives': api.unary_unary_rpc_method_handler(
            ...
            'VerifyProof': api.unary_unary_rpc_method_handler(
            ...
            'DecodeProof': api.unary_unary_rpc_method_handler(
            ...
            'ExportProof': api.unary_unary_rpc_method_handler(
            ...
            'SendAsset': api.unary_unary_rpc_method_handler(
                    servicer.SendAsset,
            ...
            'BurnAsset': api.unary_unary_rpc_method_handler(
                    servicer.BurnAsset,
            ...
            'SubscribeSendAssetEventNtfns': api.unary_stream_rpc_method_handler(
                    servicer.SubscribeSendAssetEventNtfns,
                    request_deserializer=taprootassets__pb2.SubscribeSendAssetEventNtfnsRequest.FromString,
                    response_serializer=taprootassets__pb2.SendAssetEvent.SerializeToString,
            ),
            'SubscribeReceiveAssetEventNtfns': api.unary_stream_rpc_method_handler(
                    servicer.SubscribeReceiveAssetEventNtfns,
                    request_deserializer=taprootassets__pb2.SubscribeReceiveAssetEventNtfnsRequest.FromString,
                    response_serializer=taprootassets__pb2.ReceiveAssetEvent.SerializeToString,
            ),
            'FetchAssetMeta': api.unary_unary_rpc_method_handler(
...
class TaprootAssets(object):
    ...
    def ListAssets(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/ListAssets',
    ...
    def ListUtxos(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/ListUtxos',
    ...
    def ListGroups(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/ListGroups',
    ...
    def ListBalances(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/ListBalances',
    ...
    def ListTransfers(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/ListTransfers',
    ...
    def StopDaemon(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/StopDaemon',
    ...
    def DebugLevel(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/DebugLevel',
    ...
    def QueryAddrs(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/QueryAddrs',
    ...
    def NewAddr(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/NewAddr',
    ...
    def DecodeAddr(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/DecodeAddr',
    ...
    def AddrReceives(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/AddrReceives',
    ...
    def VerifyProof(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/VerifyProof',
    ...
    def DecodeProof(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/DecodeProof',
    ...
    def ExportProof(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/ExportProof',
    ...
    def SendAsset(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/SendAsset',
    ...
    def BurnAsset(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/BurnAsset',
    ...
    def GetInfo(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/GetInfo',
    ...
    def SubscribeSendAssetEventNtfns(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_stream(request, target, '/taprpc.TaprootAssets/SubscribeSendAssetEventNtfns',
            taprootassets__pb2.SubscribeSendAssetEventNtfnsRequest.SerializeToString,
            taprootassets__pb2.SendAssetEvent.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SubscribeReceiveAssetEventNtfns(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_stream(request, target, '/taprpc.TaprootAssets/SubscribeReceiveAssetEventNtfns',
            taprootassets__pb2.SubscribeReceiveAssetEventNtfnsRequest.SerializeToString,
            taprootassets__pb2.ReceiveAssetEvent.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def FetchAssetMeta(request,
            ...
            timeout=None,
            metadata=None):
        return api.experimental.unary_unary(request, target, '/taprpc.TaprootAssets/FetchAssetMeta',
